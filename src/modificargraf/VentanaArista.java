...
public class VentanaArista extends javax.swing.JFrame 
{
  ...
  private int i=0;
    ...
    public VentanaArista(Arboles arbole,Dibujar pinta ,int I,Frame frame)
    {
       this.pintar =pinta;
       this.arboles=arbole;
       this.i=I;
        ...
        else
        {
           ...
           ta=Integer.parseInt(tm.getText());         
            ...
            else
            {
              ...
              n2.setText(null);
              tm.setText(null);
              Dibujar.pintarLinea(Principal.PanelDibujar.getGraphics(),arboles.getCordeX(x), arboles.getCordeY(x), arboles.getCordeX(y), arboles.getCordeY(y), ta);     
            } 
        }
