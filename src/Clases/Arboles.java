...
{
  private int mCoeficiente[][] = new int [50][50];
  private int mAdyacencia [][] = new int [50][50];
  private int cordeX [] = new int [50];
  private int cordeY [] = new int [50];
  private int nombre [] = new int [50];
  private int enArbol [];
